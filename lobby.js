...
module.exports = class Lobby {
   ...
   */
  constructor(code, game, isCPU,solidityDeck) {
  ...
  // Use the provided solidityDeck if available, otherwise generate a new deck
  if (solidityDeck) {
    this.convertDeckFromSolidity(solidityDeck);
  } else {
    this._genCards();
  }
  ...
  convertDeckFromSolidity(solidityDeck) {
